...
import com.ngochung.ApiGatewayBeApp;
import com.ngochung.config.AsyncSyncConfiguration;
import com.ngochung.config.EmbeddedSQL;
...
@SpringBootTest(classes = { ApiGatewayBeApp.class, AsyncSyncConfiguration.class })
@EmbeddedSQL
