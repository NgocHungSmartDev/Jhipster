...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.ngochung.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.ngochung.security.DomainUserDetailsService", "createSpringSecurityUser");
    }
}
